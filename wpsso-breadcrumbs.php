 ...
 * Description: WPSSO Core add-on to provide JSON-LD formatted Schema BreadcrumbList markup for Google and Search Engine Optimization (SEO).
 * Requires PHP: 5.4
	...
	class WpssoBc {
		...
		private function min_version_notice() {
			...
			if ( method_exists( 'SucomUtil', 'safe_trigger_error' ) ) {
				...
				$error_prefix = sprintf( __( '%s warning:', 'wpsso-breadcrumbs' ), $info['short'] );
