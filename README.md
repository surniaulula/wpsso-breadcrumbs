...
<tr><th align="right" valign="top" nowrap>Summary</th><td>WPSSO Core add-on offers JSON-LD formatted Schema BreadcrumbList markup for Google and Search Engine Optimization (SEO).</td></tr>
