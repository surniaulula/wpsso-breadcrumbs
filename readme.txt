=== WPSSO Breadcrumbs Markup - Improve Search Results with Schema Breadcrumbs for Google and Search Engine Optimization (SEO) ===
...
Tags: breadcrumbs, hierarchy, seo, google, categories, tags, search
...
**New Extension for the WPSSO Core Plugin:**

WPSSO Breadcrumbs Markup (aka WPSSO BC) is the newest extension for the WPSSO Core plugin. You can expect many more features in future versions, including breadcrumbs markup for archive type pages (dates, tags, categories, and custom terms / taxonomies).
...
(2018/02/22) Refactored the WpssoBc min_version_notice() method to use PHP's trigger_error() and include a notice to refresh plugin update information.
