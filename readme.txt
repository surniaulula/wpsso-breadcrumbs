...
**Version 2.9.0-dev.10 (2020/08/10)**
...
* **Requires At Least**
	* PHP v5.6.
	* WordPress v4.2.
	* WPSSO Core v8.0.0-dev.10

**Version 2.8.0 (2020/08/02)**
...
(2020/08/10) Added support for the new WpssoUtilMetabox class in WPSSO Core v8.0.0.
