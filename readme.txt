...
**Version 1.1.0-dev.2 (2018/02/19)**
...
(2018/02/19) Refactored the WpssoBc min_version_notice() method to use PHP's trigger_error() and include a notice to refresh plugin update information.
