...
**Version 3.3.0-dev.1 (2020/12/09)**
...
* **Bugfixes**
	* None.
* **Developer Notes**
	* Added support for new `$mod` array elements in WPSSO Core v8.17.0.
* **Requires At Least**
	* PHP v5.6.
	* WordPress v4.5.
...
(2020/12/09) Added support for new `$mod` array elements in WPSSO Core v8.17.0.
